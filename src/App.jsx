...
import { WINNING_COMBINATIONS } from "./assets/components/winning-combinations";
...
function App() {
  const [playrs ,setPlayers]= useState({
    'X' : 'Player 1',
    'O' : 'Player 2'
  });
  ...
  let gameBorad =[...initalGameBoard.map(array => [...array])] ;
  ...
  for (const combination of WINNING_COMBINATIONS) {
    ...
    if (
      ...
      winner =playrs[firstSquareSymbol];
    }
  }
  ...
  function handlePlayerNameVhange(symbol,newName){
      ...
      <div id="game-container">
        <ol id="players" className="highlight-player">
          <Player
            ...
            onChangeName={handlePlayerNameVhange}
